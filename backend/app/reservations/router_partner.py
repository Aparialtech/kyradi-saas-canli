...
async def create_manual_reservation(
    ...
    reservation = WidgetReservation(
        ...
        checkin_date=payload.checkin_date or (payload.start_datetime.date() if payload.start_datetime else None),
        checkout_date=payload.checkout_date or (payload.end_datetime.date() if payload.end_datetime else None),
