...
def upgrade() -> None:
    # Add fields to main reservations table
    ...
    # Add fields to widget_reservations table
...
def downgrade() -> None:
    # Remove fields from widget_reservations table
    ...
    # Remove fields from main reservations table
